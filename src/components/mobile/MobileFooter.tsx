  ...
  return (
    <section id="contact" className="mobile-contact">
      ...
      <p className="mobile-contact-copy">
        Open to software engineering internships, hackathons, and building
        products with strong teams.
      </p>

      <a className="mobile-contact-email" href="mailto:raihancarder@gmail.com">
      ...
      <div className="mobile-contact-links" aria-label="Contact links">
        <a
        ...
        <a className="mobile-contact-link" href={resumePdf} download aria-label="Resume">
          <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <a className="mobile-contact-top" href="#" onClick={goMobile("top")}>
        Back to top
      </a>

      <p className="mobile-contact-note">Created by Raihan Carder</p>
    </section>
  );
}
